...
Config.Kits = {
    ['police'] = { -- Kit Name
        ...
        description = 'A kit for the police department' -- Description of the kit
    },
    ['ambulance'] = {
        name = 'Ambulance Kit', 
        items = {
        ...
        price = 750,
        job = 'ambulance',
        description = 'A kit for the ambulance department'
    },
    ...
    ['mechanic'] = {
        ...
        price = 500,
        job = 'mosleys',
        description = 'A kit for the mechanic department'
    }
}
